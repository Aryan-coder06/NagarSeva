...
function Privacy() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-emerald-400/20 dark:bg-emerald-500/10 rounded-full blur-3xl animate-blob-1"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl mb-8 shadow-xl transform hover:scale-110 hover:rotate-6 transition-all duration-500">
            <Shield className="w-10 h-10 text-white" />
          </div>
          <h1 className="font-heading text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-500 bg-clip-text text-transparent mb-6 pb-3">
            Privacy Policy
          </h1>
            ...
            >
              ...
              >
                <div className="flex items-center space-x-4">
                  <div
                    className={`flex items-center justify-center w-12 h-12 rounded-xl text-white shadow-md transition-all duration-500 ${
                      expandedSection === section.id
                        ? "bg-gradient-to-br from-emerald-500 to-teal-500 scale-110 rotate-12"
                  ...
                  <div>
                    <h3 className="font-heading text-xl font-semibold text-gray-900 dark:text-white mb-1">
                      {section.title}
                    </h3>
                ...
                {expandedSection === section.id && (
                  ...
                  >
                    <div className="px-6 pb-6">
                      <div className="bg-gradient-to-r from-emerald-50 to-emerald-50 dark:from-emerald-900/20 dark:to-emerald-900/20 rounded-xl p-6 border-l-4 border-emerald-500 shadow-inner">
        ...
        <div className="bg-gradient-to-r from-emerald-500 to-cyan-600 rounded-2xl p-10 text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="font-heading text-2xl font-bold mb-3">Changes to This Policy</h3>
