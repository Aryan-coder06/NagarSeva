  ...
  const terms = [
    {
      ...
      content: 'You agree to use NagarSeva for lawful purposes only and not to misuse or interfere with the platform\'s functionality. This includes respecting community guidelines and reporting issues in good faith.',
    ...
    },
    {
      ...
      bgGradient: 'from-emerald-50 to-emerald-50 dark:from-emerald-900/20 dark:to-emerald-900/20'
    },
    {
      id: 'updates',
      icon: <RefreshCw className="w-6 h-6" />,
      title: 'Updates to Terms',
      content: 'We may revise these terms periodically to reflect changes in our services or legal requirements. Continued use of NagarSeva constitutes your acceptance of any changes.',
      color: 'from-emerald-500 to-teal-600',
      bgGradient: 'from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20'
    }
  ];
    ...
    <div className="relative min-h-screen">
      ...
      {showTop && (
        <button 
          ...
          className="fixed bottom-8 right-8 p-3 rounded-full bg-gradient-to-br from-teal-600 to-emerald-600 text-white shadow-lg hover:shadow-xl transition-all duration-300"
        >
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-teal-500/10 via-emerald-500/10 to-emerald-500/10 dark:from-teal-400/5 dark:via-emerald-400/5 dark:to-emerald-400/5"></div>
        
        <div className="absolute top-20 left-10 w-28 h-28 bg-gradient-to-br from-teal-400/20 to-emerald-400/20 rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-teal-600 via-emerald-600 to-emerald-600 rounded-3xl mb-8 shadow-2xl rotate-[-3deg] hover:rotate-0 transition-transform duration-700 ease-out">
            <Scale className="w-12 h-12 text-white" />
          </div>
          
          <h1 className="font-heading text-6xl md:text-7xl font-black bg-gradient-to-r from-teal-600 via-emerald-600 to-emerald-600 bg-clip-text text-transparent mb-6 leading-tight">
            Terms of Service
          </h1>
          
          <p className="max-w-3xl mx-auto text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed mb-10">
            These Terms of Service govern your use of <span className="font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">NagarSeva</span>. 
            ...
            >
              ...
              <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border border-gray-200/50 dark:border-gray-700/50 rounded-3xl p-10 shadow-lg group-hover:shadow-xl">
                <div className="flex items-start gap-6 mb-6">
                  ...
                  <div>
                    <h2 className="font-heading text-2xl md:text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                      {term.title}
                      <ChevronRight 
